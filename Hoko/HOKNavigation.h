 ...
 *
 */
@interface HOKNavigation : NSObject
 ...
 */
+ (void)setRootViewController:(hok_nonnull UIViewController *)viewController;
 ...
 */
+ (void)pushViewController:(hok_nonnull UIViewController *)viewController animated:(BOOL)animated;
 ...
 *  @param animated       If you choose to animate the pushing of the viewController.
 */
+ (void)pushViewController:(hok_nonnull UIViewController *)viewController animated:(BOOL)animated replace:(BOOL)replace;
 ...
 */
+ (void)presentViewController:(hok_nonnull UIViewController *)viewController animated:(BOOL)animated;
