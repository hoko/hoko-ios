 ...
 *  registerForRemoteNotificationTypes: call on the HKPushNotifications module.
 */
 ...
 *  easier integration.
 */
@interface HKPushNotifications : NSObject
...
#ifndef HokoPushNotifications
  #define HokoPushNotifications [Hoko pushNotifications]
#endif
